...
const defaultBaseUrl = 'https://gateway-uat.qianzizhilian.com/'
// const defaultBaseUrl = 'https://gateway.qianzizhilian.com/'
...
service.interceptors.request.use(
    (config) => {
        config.headers['freed-auth'] = window.authToken
